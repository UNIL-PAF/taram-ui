...
import {prepareStatTestParams} from "./StatTestPrepareParams"
import {getStepTitle, getTable, getTableCol} from "../CommonStepUtils";
import {typeToName} from "../TypeNameMapping"
import {getStatTestName} from "./StatTestType";

export default function StatTest(props) {
    const type = "stat-test"
    ...
    const testName = (myParams) => {
        const myName = getStatTestName(myParams.statTestType)
    ...
    return (
        <Card className={"analysis-step-card" + (props.isSelected ? " analysis-step-sel" : "")}
            ...
            <AnalysisStepMenu stepId={props.data.id}
                              ...
                              prepareParams={prepareStatTestParams}
