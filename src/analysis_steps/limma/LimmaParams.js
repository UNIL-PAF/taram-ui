...
import LimmaGroupSelection from "./LimmaGroupSelection"
import {getNumCols} from "../CommonStepUtils";

const {Option} = Select;

export default function LimmaParams(props) {
        ...
        return <>
            ...
            <InputNumber
                ...
                {props.params && props.params.columns &&
                    <LimmaGroupSelection columns={props.params.columns} setColumns={setColumns}></LimmaGroupSelection>}
            </Space>
        </>
    }
